...
def compute_normalized_distance(distances_dict):
    """The input is dictionary containing distance covered by each one of the alternatives
        in km"""
...
def compute_normalized_num_stops(num_stops_dict):
    """The input is dictionary containing the number of stops of each one of the alternatives"""
